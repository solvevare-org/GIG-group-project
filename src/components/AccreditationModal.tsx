...
const AccreditationModal = ({ isOpen, onClose }: AccreditationModalProps) => {
  ...
  // Amount options: $10 (test), then $50,000 to $2,000,000 in $50,000 increments
  const amountOptions = [10, ...Array.from({ length: 40 }, (_, i) => 50000 + i * 50000)];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80 backdrop-blur-sm">
      <div className="bg-gray-900 border border-red-500 rounded-2xl p-4 max-w-3xl w-full mx-2 relative overflow-y-auto max-h-[90vh] text-sm text-gray-300">
        ...
        {step === 3 && (
          <>
            <div className="text-center mb-4">
              <h2 className="text-xl font-bold text-white mb-2">Choose Investment Amount</h2>
              <p className="text-xs text-gray-400">Pick your investor amount below.</p>
            </div>
            <select
